...
-- NAMEPLATES
------------------------------------------------------------------------------------------
local MaxUINamePlates = function(self)
	local Window = self:CreateWindow("MaxUINamePlates")
	...
	Window:CreateSection("All", "Stacking / Overlapping")
...
GUI:AddWidgets(MaxUINamePlates)

------------------------------------------------------------------------------------------
-- PARTY
------------------------------------------------------------------------------------------
local MaxUIParty = function(self)
	local Window = self:CreateWindow("MaxUIParty")
	...
	Window:CreateSwitch("All", "Party", "ShowPets", "Enable Pets")
	Window:CreateSpacerNoPos("All")
	...
	Window:CreateSwitch("All", "Party", "RoleIcon", "|cffFFFF99Show a role icon|r")
	Window:CreateSpacerNoPos("All")
	
	Window:CreateSection("All", "Highlighting")
...
GUI:AddWidgets(MaxUIParty)

------------------------------------------------------------------------------------------
-- RAID
------------------------------------------------------------------------------------------
local MaxUIRaid = function(self)
	local Window = self:CreateWindow("MaxUIRaid")
	...
	Window:CreateSpacer("All", 4)
	Window:CreateSpacer("All", 5)
	Window:CreateExplanationText("All", 6, "Settings for the raidframes. Also used as party when partyframes are disabled.")
	Window:CreateSpacer("All", 7)
	...
	Window:CreateDropdown("All", "Raid", "GrowDirection", "Set anchor direction for units and groups")
	...
	Window:CreateSection("All", "Settings |cffffff00[RAID 1->25]|r")
	...
	Window:CreateSlider("All", "Raid", "Padding", "Spacing in pixels between units", 0, 20, 1) -- needs testing
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "Settings |cf00fff00[RAID 25->40]|r")
	...
	Window:CreateSlider("All", "Raid", "Padding40", "Spacing in pixels between units", 0, 20, 1) -- needs testing
	Window:CreateSpacerNoPos("All")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateSwitch("All", "Raid", "ShowPercentageHealth", "Enable a seperate health percentage tag")
	...
	Window:CreateSection("All", "Name")
	Window:CreateDropdown("All", "Raid", "Font", "Set raid name font", "Font")
	...
	elseif C.Raid.RaidBuffsStyle.Value == "Aura Track" then
		...
		Window:CreateSlider("All", "Raid", "AuraTrackThickness", "Thickness size of status bars", 2, 10, 1)
	end
	Window:CreateSpacerNoPos("All")
	...
	Window:CreateSectionButton("All", "Custom tracking", "Open the debuff tracking tool", GUI.TukuiDebuffTracking)
...
GUI:AddWidgets(MaxUIRaid)

------------------------------------------------------------------------------------------
-- UNITFRAMES - GENERAL
------------------------------------------------------------------------------------------
local MaxUIUnitFrames = function(self)
	local Window = self:CreateWindow("MaxUIUnitFrames")
	...
	Window:CreateSection("All", "Health statusbar color")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "HEALTH TAG SETTINGS")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "POWER TAG SETTINGS")
	...
	--Window:CreateSection("All", "Names")
	...
	Window:CreateSection("All", "Castbar")
	--Window:CreateSwitch("All", "UnitFrames", "CastBar", "Enable castbar for all available unitframes")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "REMAINING TIME TEXT SETTINGS")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "COUNT TEXT SETTINGS")
	...
	Window:CreateSection("All", "Combat feedback (Player and target")
	Window:CreateSwitch("All", "UnitFrames", "CombatLog", "Enable combat feedback text")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "Icons")
	Window:CreateDropdown("All", "UnitFrames", "Roles", "Set style for role icons used on all unitframes")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "Highlighting")
	Window:CreateSlider("All", "UnitFrames", "HighlightSize", "Set highlight size", 5, 15, 1)
	Window:CreateColorSelection("All", "UnitFrames", "HighlightColor", "Set highlight color")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "Portrait")
	Window:CreateSwitch("All", "UnitFrames", "Portrait", "Enable unit portraits")
	Window:CreateSwitch("All", "UnitFrames", "Portrait2D", "Use a static 2D Portrait")
end
GUI:AddWidgets(MaxUIUnitFrames)
...
local ClassOptions = function(self)
	...
	Window:CreateSection("All", "Enable")
	Window:CreateSwitch("Retail", "UnitFrames", "ClassBar", "Enable class bar for available classes (example: holy power)")
	Window:CreateSpacerNoPos("All")
	...
	Window:CreateSection("Classic", "Custom Mana / Energy Regen Ticker")
	Window:CreateSwitch("Classic", "UnitFrames", "PowerTick", "|cffFFFF99Enable Mana/Energy Ticker|r")
	Window:CreateSwitch("Classic", "ClassOptions", "MaxUITicker", "|cffFFFF99Enable Standalone Mana/Energy Ticker|r")
	Window:CreateSlider("Classic", "ClassOptions", "MaxUITickerLength", "|cffFFFF99Set Length for the custom Ticker|r", 30, 300, 1)
	Window:CreateDropdown("Classic", "ClassOptions", "OrientationTicker", " |cffFFFF99Orientation custom Ticker|r")
	Window:CreateSpacerNoPos("Classic")
...
local Player = function(self)
	...
	Window:CreateSection("All", "extra info tag")
...
local Target = function(self)
	...
	Window:CreateSection("All", "Threat color")
...
local Boss = function(self)
	...
	Window:CreateSection("All", "Threat olor")
