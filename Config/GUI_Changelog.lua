...
local MaxUIChangelog = function(self)
	...
	Window:CreateTextLine("All", "|cffFFFF99EXPLANATION:|r")
	...
	Window:CreateTextLine("All", "|cffFFFF99add a screenshot and a textmessage of the lua error,|r")
	...
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "- ALL: added functionality to the chat shortcut tool, found in chat section.")
	Window:CreateTextLine("All", "- ALL: rightclicking guild/officer chat button, now checks if permitted.")
	Window:CreateTextLine("All", "- ALL: rightclick on map datatext should onlyopen worldmap now.")
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "- ALL: GUI AND SETTINGS CLEANUP AND REORGANIZATION:")
	Window:CreateTextLine("All", "- ALL: by reorganizing and cleaning the GUI and settings, renaming/replacing settings,")
	Window:CreateTextLine("All", "some settings might be reset or found in a different section. Apologies.")
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("All", "- ALL: added a show tukui old gui sections button, just in case.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated general section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated actionbars section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated bag section, added autosell and autorepair here.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated chat section, moved chat shortcuts tool here.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated loot section, removed grouploot test button for now, broken.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated map section, moved quest section into this, saving space.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated misc section, moved tools section into this section saving space.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated unitframes section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated class section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated player section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated target section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated targetoftarget section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated pet section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated focus section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated boss section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated raid section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated party section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: reorganized/updated nameplates section, checks and cleanup.")
	Window:CreateTextLine("All", "- ALL: removed twitter button from Micro Menu.")
	Window:CreateSpacerNoPos("All")
	Window:CreateTextLine("ALL", "- CLASSIC: temp fix for profile reset popup error on load.")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "MaxUI 6.704")
	Window:CreateTextLine("All", "- ALL: minor undocumented fixes")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "MaxUI 6.703")
	Window:CreateTextLine("All", "- ALL: Matching Tukui 20.38")
	Window:CreateTextLine("All", "- ALL: Minimap Button Bar skin (Project Azilroka)")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "MaxUI 6.702")
	Window:CreateTextLine("All", "- ALL: AFK Screen cleanup")
	Window:CreateTextLine("All", "- ALL: some code cleanup")
	Window:CreateSpacerNoPos("All")

	Window:CreateSection("All", "MaxUI 6.701")
	Window:CreateTextLine("All", "- ALL Minor Fixes for WotLK and Classic to load correctly")
	Window:CreateSpacerNoPos("All")
