...
local function SkinImmersionToMaxUIStyle()
	...
	ImmersionFrame.TalkBox:CreateBackdrop("Transparent")
	ImmersionFrame.TalkBox.Backdrop:SetOutside(ImmersionFrame.TalkBox)
	ImmersionFrame.TalkBox.Backdrop:CreateShadow()
	...
	--ImmersionFrame.TalkBox.Elements.Backdrop:SetOutside(ImmersionFrame.TalkBox.Elements)
	...
	ImmersionFrame.TalkBox.ReputationBar:SkinMaxUIStatusBar()
	...
	if C["Skins"]["BackdropFilter"] then 
		ImmersionFrame.TalkBox.Backdrop:CreateMaxUIFilter()
