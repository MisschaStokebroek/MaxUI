...
-- SOCKETUI
------------------------------------------------------------------------------------------
local AS_Blizzard_ItemSocketingUI = AS.Blizzard_ItemSocketingUI
function AS:Blizzard_ItemSocketingUI(event, addon)
	AS_Blizzard_ItemSocketingUI(self, event, addon)
	...
	-- adjustments
	_G.ItemSocketingFrameInset:Hide()
	_G.ItemSocketingSocketButton:SetWidth(84)
	
	_G.ItemSocketingScrollFrameScrollBar:ClearAllPoints()
	_G.ItemSocketingScrollFrameScrollBar:SetPoint("LEFT", _G.ItemSocketingScrollFrame , "RIGHT", 6, 1)
	_G.ItemSocketingScrollFrameScrollBar:SetHeight(	ItemSocketingScrollFrameScrollBar:GetHeight() +1)

	-- header
	_G.ItemSocketingFrame:CreateMaxUIHeader("Inspect")

	-- close button
	_G.ItemSocketingFrameCloseButton:ClearAllPoints()
	_G.ItemSocketingFrameCloseButton:SetPoint("RIGHT", _G.ItemSocketingFrame.MaxUIHeader, "RIGHT", 4, 0)

	-- relocate
	_G.ItemSocketingFrame:ClearAllPoints()
	_G.ItemSocketingFrame:SetPoint("TOP", UIParent, "TOP", 0, -100)
	_G.ItemSocketingFrame.ClearAllPoints = function() end
	_G.ItemSocketingFrame.SetPoint = function() end
