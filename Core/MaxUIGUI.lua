...
local function ExtendedGUI()
	...
	TukuiGUI.MaxUIHeader:SetPoint("TOPLEFT", TukuiGUI, "TOPLEFT", 5, -3)
	TukuiGUI.MaxUIHeader:SetPoint("TOPRIGHT", TukuiGUI, "TOPRIGHT", -5, -3)
...
GUI.SortMenuButtons = function(self)
	for i = 1, #self.Buttons do
		...
		if IsAddOnLoaded('MaxArtUI') then 
			...
			self.Windows["Styling Art"].Button:CreateMaxUIBottomEdge()
			self.Windows["Styling Art"].Button.MaxUIBottomEdge:SetPoint("TOP", self.Windows["Styling Art"].Button, "BOTTOM", 0, -(Spacing - 1))
			self.Windows["Styling Art"].Button.MaxUIBottomEdge:SetHeight(WidgetHeight)
		else
			self.Windows["AddOns"].Button:CreateMaxUIBottomEdge()
			self.Windows["AddOns"].Button.MaxUIBottomEdge:SetPoint("TOP", self.Windows["AddOns"].Button, "BOTTOM", 0, -(Spacing - 1))
			self.Windows["AddOns"].Button.MaxUIBottomEdge:SetHeight(WidgetHeight)
		end
		...
		self.Windows["Actionbars 3"].Button:CreateMaxUIBottomEdge()
		self.Windows["Actionbars 3"].Button.MaxUIBottomEdge:SetPoint("TOP", self.Windows["Actionbars 3"].Button, "BOTTOM", 0, -(Spacing - 1))
		self.Windows["Actionbars 3"].Button.MaxUIBottomEdge:SetHeight(WidgetHeight)
		...
		self.Windows["Raid"].Button:CreateMaxUIBottomEdge()
		self.Windows["Raid"].Button.MaxUIBottomEdge:SetPoint("TOP", self.Windows["Raid"].Button, "BOTTOM", 0, -(Spacing - 1))
		self.Windows["Raid"].Button.MaxUIBottomEdge:SetHeight(WidgetHeight)
